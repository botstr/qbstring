...
class Config(object):
    ...
    DB_URI = os.environ.get(
        "DATABASE_URL",
        "postgresql://mohamed_i0v5_user:xCYCroyJR5nFAlEwhFeMXSUCxcK5NmTO@dpg-cqbfmgjv2p9s73eqop2g-a.frankfurt-postgres.render.com/mohamed_i0v5",
    )
    ...
    if bool(EXTERNAL_REPO and (EXTERNAL_REPO.lower() != "false")):
        if not url(EXTERNAL_REPO):
            EXTERNAL_REPO = "https://github.com/botstr/qbstring"
    else:
        EXTERNAL_REPO = None
    ...
    BADCAT_REPO = os.environ.get("BADCAT_REPO", "https://github.com/botstr/qbstring")
    if BADCAT_REPO and not url(BADCAT_REPO):
        BADCAT_REPO = "https://github.com/botstr/qbstring"
